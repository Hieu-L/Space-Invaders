...
entity game is
	Port(
         ...
         lost : in  STD_LOGIC;										-- La Balle Va Sortir de l'Ecran
			...
			-- COULEUR A AFFICHER
			red : out  STD_LOGIC_VECTOR(3 downto 0);										-- Affichage Rouge
         green : out  STD_LOGIC_VECTOR(3 downto 0);										-- Affichage Vert
         blue : out  STD_LOGIC_VECTOR(3 downto 0);										-- Affichage Bleu
